...
var real__logArrayOfInt32 = asm["_logArrayOfInt32"]; asm["_logArrayOfInt32"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__logArrayOfInt32.apply(null, arguments);
};
...
var real__logArrayOfInt = asm["_logArrayOfInt"]; asm["_logArrayOfInt"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__logArrayOfInt.apply(null, arguments);
};
...
var _logArrayOfInt32 = Module["_logArrayOfInt32"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_logArrayOfInt32"].apply(null, arguments) };
...
var _logArrayOfInt = Module["_logArrayOfInt"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_logArrayOfInt"].apply(null, arguments) };
