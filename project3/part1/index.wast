(module
 ...
 (export "_addFloat" (func $legalstub$_addFloat))
 ...
 (func $_add (param $$p1 i32) (param $$p2 i32) (result i32)
  (local $$0 i32)
  (local $$1 i32)
  (local $$2 i32)
  (local $$3 i32)
 ...
 (func $_addFloat (param $$p1 f32) (param $$p2 f32) (result f32)
  (local $$0 f32)
  (local $$1 f32)
  (local $$2 f32)
  (local $$3 f32)
 ...
 (func $legalstub$_addFloat (param $0 f64) (param $1 f64) (result f64)
  (f64.promote/f32
   (call $_addFloat
    (f32.demote/f64
     (get_local $0)
